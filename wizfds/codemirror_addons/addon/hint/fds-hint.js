...
(function (mod) {
	...
	attributes['vent'] = ('FYI COLOR CTRL_ID DEVC_ID DYNAMIC_PRESSURE EVACUATION ID IOR L_EDDY L_EDDY_IJ MB MESH_ID MULT_ID N_EDDY OUTLINE PBX PRESSURE_RAMP RADIUS REYNOLDS_STRESS RGB SPREAD_RATE SURF_ID TEXTURE_ORIGIN TMP_EXTERIOR TMP_EXTERIOR_RAMP TRANSPARENCY UVW VEL_RMS XB XYZ').split(' ');
