...
| **`.bf`** (`BNDF` / `BNDC`) | boundary — wielkości na powierzchniach obst i na ścianach domeny | `INITIALIZE_MESH_DUMPS` (płaty) + `DUMP_BNDF` (klatki) w [`dump.f90`](https://github.com/firemodels/fds/blob/master/Source/dump.f90) | (parser w `getdata.c`/IO) | [`smokeview/IOboundary.c`](https://github.com/firemodels/smv/blob/master/Source/smokeview/IOboundary.c) | [`parsers/bf/bf-parser.ts`](../../projects/web-smokeview-lib/src/lib/services/parsers/bf/bf-parser.ts) (format) + [`drawing/bndf/bndf.service.ts`](../../projects/web-smokeview-lib/src/lib/services/drawing/bndf/bndf.service.ts) (rendering, #152; BNDC → #159) |
...
| Odtwarzanie w czasie (animacja) | menu/update w `smokeview/menus.c`, `update.c` | [`services/timeline/timeline.service.ts`](../../projects/web-smokeview-lib/src/lib/services/timeline/timeline.service.ts) (oś w sekundach symulacji, ADR-0018) + [`services/timeline/frame-at.ts`](../../projects/web-smokeview-lib/src/lib/services/timeline/frame-at.ts) (czas→klatka) + [`views/timeline-bar/`](../../projects/web-smokeview-lib/src/lib/views/timeline-bar/) (pasek) |
